...
Begin Window LocateImportFolder
   ...
   Placement       =   0
   Resizeable      =   True
   Title           =   "Select the Participant Import file..."
   Visible         =   True
   Width           =   433
	...
	#tag Event
		Sub Action()
		  ...
		  if rbComma.Value then
		    ...
		    Dynamic.Seperator=chr(9)
		  end if
		  
		  Select Case Dynamic.ImportType
		    
		  Case "Participants"
		    Dynamic.ImportParticipantData
		    
		  Case "Transponders"
		    Dynamic.ImportTXData
